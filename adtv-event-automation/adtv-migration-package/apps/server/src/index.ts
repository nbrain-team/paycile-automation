...
app.post('/admin/resolve-migrations', async (req, res) => {
  try {
    ...
    const migrations = ['20250910155615_init', '20250910182327_add_campaign_graph', '20250910195733_add_user', '20250910201254_add_campaign_sender', '20250116000000_add_template_versioning'];
