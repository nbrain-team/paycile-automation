...
export type CampaignStatus = 'draft' | 'enriching' | 'ready_for_personalization' | 'generating_emails' | 'ready_to_send' | 'active' | 'paused' | 'stopped' | 'archived';
export type EventType = 'virtual' | 'in_person' | 'b2b_outreach';
